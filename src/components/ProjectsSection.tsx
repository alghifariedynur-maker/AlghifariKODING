...
const projects = [
  {
    title: 'WINNER TAEKWONDO CHAMPIONSHIP',
    description: 'ALGHIFARI ATLET TAEKWONDO DARI CLUB SETDA ACEH MENJUARAI KEJUARAAN POPDA.',
  ...
  {
    title:'WINNER BERHITUNG CEPAT',
    description: 'MENJUARAI ACARA BERHITUNG CEPAT SEKABUPATEN.',
  ...
  {
    title: 'WINNER PASKIBRAKA',
    description: 'PERNAH MENGIKUTI SELEKSI PASKIBRAKA TINGKAT PROVINSI.',
